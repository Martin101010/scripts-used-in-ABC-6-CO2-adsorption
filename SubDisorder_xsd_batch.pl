...
#
# xsd verson!
# For the xsd files that already imported in a project. Only read the file list in inputdir instead of import the files.
#
# 
# Modifications:
...
my $inputdir="C:/Users/61068/Desktop/input";
my $export_dir = "D:/xftp download/test_cif";
...
my $xsd = $Documents{"$list[$l]"};# Please don't change it.
my $percentChange = 40;		# Percentage of atoms of original element to change
